                ...
                <div class="table-header">
                    ...
                    <div class="table-header__right">
                        <div class="products-filter">
                            <span id="total_items">Mostrando 00 de 00 marcas</span>
                            <div class="drop_hov">
                        ...
                        <a href="<?php echo RUTA; ?>/admin/marcas-new.php" class="button_new">Añadir Marca</a>
                    </div>
                </div>
                <table>
                    <thead>
...
<script src="<?php echo RUTA; ?>/admin/ajax/marcas.ajax.js"></script>
