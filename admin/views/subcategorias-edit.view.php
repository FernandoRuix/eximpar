            ...
            <div class="table-container">
                <div class="table-header">
                    ...
                    <div class="table-header__right">
                        <a href="<?php echo RUTA; ?>/admin/subcategorias-list.php" class="button_new">Lista de Subcategorías</a>
                    </div>
                </div>
                <div class="form-container">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="form">
                        ...
                        <input type="hidden" name="hidden_id" value="<?php echo $single[0]['subcategorias_id']; ?>">

                        <div class="form-group">
                            <input type="text" name="nombre" placeholder="Título" class="form-input" value="<?php echo $single[0]['subca_titulo']; ?>" autocomplete="OFF">
                        </div>
                        ...
                        <div class="form-submit">
                            <input type="submit" value="Editar Subcategoría">
                        </div>
                    </form>
