                ...
                <div class="form-container">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="form">
                        ...
                        <div class="form-group">
                            <input type="text" name="nombre" placeholder="Título" class="form-input" autocomplete="OFF">
                        </div>

                        <textarea id="editorck" name="descripcion" placeholder="Descripción del producto..."></textarea>

                        <div class="form-group">
                            <input type="text" name="presentacion" placeholder="Presentacion // Subtítulo" class="form-input" autocomplete="OFF">
                        </div>

                        <div class="form-group">
                            <input type="text" name="codigo" placeholder="Código" class="form-input" autocomplete="OFF">
                        </div>

                        <div class="form-group select-group">
                            
                            <select name="categoria" required>
                                <option selected disabled>Choose a categoría</option>
                            ...
                            <select name="subcategoria" required>
                                <option selected disabled>Choose a subcategoría</option>
                            ...
                            <select name="marca" required>
                                <option selected disabled>Choose a marca</option>
                        ...
                        <div>
                            <div class="uploadOuter">
                                ...
                                <input name="thumb" type="file" onChange="dragNdrop(event)"  ondragover="drag()" ondrop="drop()" id="uploadFile" required/>
                                </span>
                        ...
                        <div class="input-file-container">  
                            <input name="pdf" class="input-file" id="my-file" type="file" required>
