                ...
                <div class="table-header">
                    ...
                    <div class="table-header__right">
                        <div class="products-filter">
                            <span id="total_items">Mostrando 00 de 00 administradores</span>
                            <div class="drop_hov">
                        ...
                        <a href="<?php echo RUTA; ?>/admin/admins-new.php" class="button_new">Añadir Administrador</a>
                    </div>
                </div>
                <table>
                    <thead>
...
<script src="<?php echo RUTA; ?>/admin/ajax/admins.ajax.js"></script>
</body>
</html>