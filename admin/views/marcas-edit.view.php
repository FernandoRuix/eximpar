            ...
            <div class="table-container">
                <div class="table-header">
                    ...
                    <div class="table-header__right">
                        <a href="<?php echo RUTA; ?>/admin/products-list.php" class="button_new">Lista de Marcas</a>
                    </div>
                </div>
                <div class="form-container">
                    ...
                    <form enctype="multipart/form-data" method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" id="form">
                        ...
                        <input type="hidden" name="hidden_id" value="<?php echo $single[0]['marcas_id']; ?>">

                        <div class="form-group">
                            <input type="text" name="nombre" placeholder="Título" class="form-input" value="<?php echo $single[0]['mar_titulo']; ?>" autocomplete="OFF">
                        </div>
