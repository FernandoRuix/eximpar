...
<head>
    ...
    <link rel="stylesheet" href="<?php echo RUTA?>/admin/assets/css/<?php echo $css ?>" type='text/css'>
        ...
        <div class="barra__cont">
            ...
            <nav class="navbar" id="primary_nav_wrap"> 
                <div class="barra__cont--center">
                    <a href=""><img class="barra__logo" src="<?php echo RUTA; ?>/media/logo.png" alt=""></a>
                    <span class="barra__title">EXIMPAR S.R.L.</span>
                </div>
