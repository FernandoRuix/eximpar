                ...
                <div class="table-header">
                    ...
                    <div class="table-header__right">
                        <div class="products-filter">
                            <span id="total_items">Mostrando 00 de 00 subcategorias</span>
                            <div class="drop_hov">
                        ...
                        <a href="<?php echo RUTA; ?>/admin/subcategorias-new.php" class="button_new">Añadir Subcategoria</a>
                    </div>
                </div>
                <table>
                    <thead>
...
<script src="<?php echo RUTA; ?>/admin/ajax/subcategorias.ajax.js"></script>
