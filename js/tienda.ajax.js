                ...
                if (!response) {
                    ...
                    for (let z = 0; z < (totalItems); z++) {
                        ...
                        <div class='item' id='item'>
                            <div class='item-img'>
                                <a href='https://www.eximpar.com.py/producto.php?p=${response[0][z]['prd_dbtitulo']}'>
                                    <i class="fa-solid fa-eye"></i>
                                    <img src='https://www.eximpar.com.py/post_images/${response[0][z]['prd_thumb']}' alt=''>
                                </a>
                            </div>
                            <div class='item-info'> <div class='item-info__title'>
                                <a href='https://www.eximpar.com.py/producto.php?p=${response[0][z]['prd_dbtitulo']}'>
                                    <h4>${response[0][z]['prd_titulo']}
                        `;
                        ...
                        rows += `
                                ...
                                <div class='item-info__tags'>
                                    <a href='https://www.eximpar.com.py/producto.php?p=${response[0][z]['prd_dbtitulo']}'>${response[0][z]['mar_titulo']}</a> • 
                                    <a href='https://www.eximpar.com.py/producto.php?p=${response[0][z]['prd_dbtitulo']}'>${response[0][z]['subca_titulo']}</a>
                                </div>
                            </div>
                            <div class='item-link'>`
                            // _cart_action_
