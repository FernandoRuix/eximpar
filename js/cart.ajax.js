            ...
            success: function(response){
                if (!response[0]) {
                    ...
                    cart_array.forEach(element => {
                        ...
                        rows += "<img src='https://www.eximpar.com.py/post_images/"+element.item_image+"' alt=''>";
                    ...
                    if($('tbody').hasClass('main_cart_body')){
                        ...
                        cart_array.forEach(element => {
                            ...
                            main_cart += "<td> <img src='https://www.eximpar.com.py/post_images/"+element.item_image+"' alt=''> </td>";
